...
class Model(models.Model):
    id = models.UUIDField(primary_key=True, db_column="Id", default=uuid.uuid4)
    logo_url = models.ImageField(max_length=2048, db_column="LogoUrl", verbose_name="Изображение", upload_to='uploads')
    title = models.CharField(max_length=256, db_column="Title", verbose_name="Название")
    value_url = models.FileField(db_column="ValueUrl", verbose_name="Модель", upload_to='uploads')
